...
class AdminLeaveHistory extends StatefulWidget{
  ...
  @override
  State<StatefulWidget> createState() => _AdminLeaveHistoryState();
...
class _AdminLeaveHistoryState  extends State<AdminLeaveHistory>{
  ...
  void initState() {
    ...
    query=_database.reference().child("Leaves");
            ...
            return Container(child:Card(
              child: new Column(
                ...
                children: <Widget>[
                  ...
                  description==null?new Text("",style: TextStyle(fontWeight: FontWeight.normal, fontSize: _width/25, color: Colors.blueGrey),textAlign: TextAlign.left,):new Text(description,style: TextStyle(fontWeight: FontWeight.normal, fontSize: _width/25, color: Colors.blueGrey),textAlign: TextAlign.left,),
                  ...
                  if(status=="Rejected")
                    new Text(status,style: TextStyle(fontWeight: FontWeight.bold, fontSize: _width/25, color: Colors.red),textAlign: TextAlign.left,),
                ],
              ),
            ),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: new Column(
        children: <Widget>[
          new Text("Leave History",style: TextStyle(fontWeight: FontWeight.bold, fontSize: _width/15, color: Colors.deepOrangeAccent,)),
          showLeaveHistory(),
        ],
      ),
